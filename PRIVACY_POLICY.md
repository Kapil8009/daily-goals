...
The released application described by this source code does not declare Android's Internet permission and does not include advertising, analytics, or developer-operated cloud synchronization. If those features are added in a future version, this policy and the Google Play Data Safety disclosure must be updated before release.

## User control and deletion

Users can edit or delete goals within the app. They can remove all local data by clearing Daily Goals storage in Android settings or uninstalling the app. Exported JSON backup files remain wherever the user saved them and must be deleted separately.

## Changes

This policy should be updated whenever the app's behavior, dependencies, permissions, or data practices change. The updated policy should show a new revision date.

## Contact

Before publication, replace this section with the publisher's support email or website.
